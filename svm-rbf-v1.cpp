...
int main() {
    ...
    double gamma = 1.0/n;
    // uint32_t degree = 3;
    vector<vector<double>> support_vectors = read_2d_matrix_from_file("../data-kernel-model-rbf/support_vectors_rbf.txt");
    ...
    // read the data
    vector<double> dual_coeffs = read_double_data_from_file("../data-kernel-model-rbf/dual_coeff_rbf.txt");
    vector<double> bias = read_double_data_from_file("../data-kernel-model-rbf/intercept_rbf.txt");
    resize_double_vector(bias, n);
    vector<double> x = read_double_data_from_file("../data-kernel-model-rbf/xtest_rbf.txt");
    vector<double> y_ground_truth = read_double_data_from_file("../data-kernel-model-rbf/ytest_rbf.txt");
    resize_double_vector(y_ground_truth, n);
    vector<double> y_expected_score = read_double_data_from_file("../data-kernel-model-rbf/yclassificationscore.txt");
